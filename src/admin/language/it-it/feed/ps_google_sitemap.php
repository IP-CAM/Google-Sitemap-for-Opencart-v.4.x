...
$_['text_getting_started']         = '<p><strong>Panoramica:</strong> Google Sitemap per OpenCart 4.x aiuta a migliorare la visibilità del tuo negozio generando sitemap XML ottimizzate. Queste sitemap aiutano i motori di ricerca come Google a indicizzare le pagine principali del tuo sito, portando a un miglior posizionamento nei motori di ricerca e aumentando la presenza online.</p><p><strong>Requisiti:</strong> OpenCart 4.x+, PHP 7.4+ o superiore, e accesso alla tua <a href="https://search.google.com/search-console/about?hl=en" target="_blank" rel="external noopener noreferrer">Google Search Console</a> per l\'invio della sitemap.</p>';
